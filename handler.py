...
# ================ MAIN FUNCTION ========================
def handle_spellcheck(input: str, transpositions=False) -> str:
    """
    ...
    # # using nltk suggestion for now, pipeline suggestion needs a little more work
